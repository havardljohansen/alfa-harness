...
export const fuses: Fuse[] = [
  ...
  { id: "f-ign-6", block: "rtmr-ign", position: 6, ratingA: 0, name: "Spare (blower moved to constant)", circuit: "c-future-spare", source: "bus", feeds: "Reserved — the heater blower moved to the constant bus so its ~15 A doesn't go through the ignition-main relay", future: true },
