...
export const fuses: Fuse[] = [
  ...
  { id: "f-con-4", block: "rtmr-const", position: 4, ratingA: 20, name: "Heater blower", circuit: "c-cooling", source: "bus", feeds: "Single gate relay (rly-fan) common — gated 12V (~12–15 A peak) routed via fc pin 1 to the fan-adapter module. Adapter's internal SPDT selects HIGH vs LOW winding downstream; the constant-bus fuse sees the same current either way since only one winding is energised at a time. CONSTANT bus + ignition-gated via the switch coil trigger." },
