...
export const wires: Wire[] = [
  ...
  { id: "w-pos-fl", label: "POS.OUT.F", name: "Position feed → front (one wire; jumpers L→R at the lamp)", circuit: "c-position", from: { component: "sw-headlight", terminal: "58" }, to: { component: "park-fl", terminal: "58" }, gaugeClass: "medium", route: ["dash", "engine-front"], via: ["bh2", "bh4"] },
  { id: "w-pos-fr", label: "POS.FRONT.JMP", name: "Front position jumper LEFT → RIGHT (piggyback at the lamp)", circuit: "c-position", from: { component: "park-fl", terminal: "58" }, to: { component: "park-fr", terminal: "58" }, gaugeClass: "medium", route: ["engine-front"], note: "Same node as the LH lamp — jumper instead of a second parallel feed through the firewall." },
  ...
  { id: "w-brake-R", label: "BRK.JMP", name: "Rear stop LEFT → rear stop RIGHT (piggyback at the lamp)", circuit: "c-brake", from: { component: "tail-rl", terminal: "54" }, to: { component: "tail-rr", terminal: "54" }, gaugeClass: "medium", route: ["rear"], note: "Both stops share the brake-switch output — jumper at the rear, one feed through BH3." },
  ...
  { id: "w-wash-feed", label: "WASH.+I", name: "Ignition bus → washer button (fused +12)", circuit: "c-wipers", from: { component: "rtmr-ign", terminal: "f-ign-5" }, to: { component: "sw-washer", terminal: "in" }, gaugeClass: "medium", route: ["engine-front", "dash"], via: ["bh1"], note: "Washer on its own dash push, off the wiper/washer fuse." },
  { id: "w-wash-out", label: "WASH.PUMP", name: "Washer button → electric washer pump", circuit: "c-wipers", from: { component: "sw-washer", terminal: "out" }, to: { component: "washer-pump", terminal: "53c" }, gaugeClass: "medium", route: ["dash", "engine-front", "engine-rear"], via: ["bh1"], note: "Capped at the pump connector until the (deferred) electric pump is fitted — then it's plug-in." },
  { id: "w-wash-gnd", label: "WASH.31", name: "Washer pump ground (local to the engine-bay hub)", circuit: "c-wipers", from: { component: "washer-pump", terminal: "g" }, to: { component: "gnd-eng", terminal: "g" }, gaugeClass: "medium", route: ["engine-rear", "engine-front"], note: "Pump grounds locally (no return through the dash) — high-side switching keeps the motor earth short." },
