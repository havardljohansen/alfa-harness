...
export const wires: Wire[] = [
  ...
  { id: "w-pos-rear-L", label: "POS.REAR.L", name: "Switched position → rear LEFT tail", circuit: "c-position", from: { component: "sw-headlight", terminal: "58" }, to: { component: "tail-rl", terminal: "58" }, gaugeClass: "medium", route: ["dash", "rear"], via: ["bh3"], note: "Rear tails now SWITCHED off the light switch (was wrongly on constant)." },
  { id: "w-pos-rear-R", label: "POS.REAR.R", name: "Rear LEFT → rear RIGHT tail (jumper)", circuit: "c-position", from: { component: "tail-rl", terminal: "58" }, to: { component: "tail-rr", terminal: "58" }, gaugeClass: "medium", route: ["rear"] },
  ...
  { id: "w-park-tell", label: "POS.TELL", name: "Switched position → green parking tell-tale", circuit: "c-position", from: { component: "sw-headlight", terminal: "58" }, to: { component: "wl-park", terminal: "in" }, gaugeClass: "signal", route: ["dash"] },
  { id: "w-park-tell-gnd", label: "POS.TELL.GND", name: "Parking tell-tale ground", circuit: "c-position", from: { component: "wl-park", terminal: "g" }, to: { component: "gnd-dash", terminal: "g" }, gaugeClass: "signal", route: ["dash"] },
  ...
  { id: "w-side-L", label: "SIDE.L", name: "Turn-L output → side marker/repeater LEFT", circuit: "c-turn", from: { component: "rly-turnL", terminal: "87" }, to: { component: "side-l", terminal: "in" }, gaugeClass: "low", route: ["engine-front"] },
  { id: "w-side-R", label: "SIDE.R", name: "Turn-R output → side marker/repeater RIGHT", circuit: "c-turn", from: { component: "rly-turnR", terminal: "87" }, to: { component: "side-r", terminal: "in" }, gaugeClass: "low", route: ["engine-front"] },
  { id: "w-side-L-gnd", label: "SIDE.GND.L", name: "Side marker LEFT ground", circuit: "c-turn", from: { component: "side-l", terminal: "g" }, to: { component: "gnd-eng", terminal: "g" }, gaugeClass: "low", route: ["engine-front"] },
  { id: "w-side-R-gnd", label: "SIDE.GND.R", name: "Side marker RIGHT ground", circuit: "c-turn", from: { component: "side-r", terminal: "g" }, to: { component: "gnd-eng", terminal: "g" }, gaugeClass: "low", route: ["engine-front"] },
  ...
  { id: "w-ill-dim", label: "ILL.DIM", name: "Instrument-light switch DIM → dimmer preset", circuit: "c-instruments", from: { component: "sw-instr", terminal: "dim" }, to: { component: "instr-pwm", terminal: "lo" }, gaugeClass: "low", route: ["dash"] },
  { id: "w-ill-brt", label: "ILL.BRT", name: "Instrument-light switch BRIGHT → dimmer preset", circuit: "c-instruments", from: { component: "sw-instr", terminal: "bright" }, to: { component: "instr-pwm", terminal: "hi" }, gaugeClass: "low", route: ["dash"] },
  { id: "w-ill-out", label: "ILL.OUT", name: "Dimmer → panel illumination (single circuit, daisy-chains all gauges)", circuit: "c-instruments", from: { component: "instr-pwm", terminal: "out" }, to: { component: "g-fuel", terminal: "ill" }, gaugeClass: "low", route: ["dash"] },
  { id: "w-ill-pwm-gnd", label: "ILL.PWM.GND", name: "Dimmer module ground reference", circuit: "c-instruments", from: { component: "instr-pwm", terminal: "g" }, to: { component: "gnd-dash", terminal: "g" }, gaugeClass: "signal", route: ["dash"] },
