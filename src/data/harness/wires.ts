...
export const wires: Wire[] = [
  ...
  { id: "w-flash-feed", label: "HL.FLASH.+IL", name: "Ignition pos-I → dip/flash switch FLASH feed (bypasses headlight switch)", circuit: "c-headlights", from: { component: "ign-switch", terminal: "P1" }, to: { component: "sw-dipflash", terminal: "flash" }, gaugeClass: "signal", route: ["dash"] },
