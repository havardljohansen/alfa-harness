...
export const wires: Wire[] = [
  ...
  { id: "w-pos-fl", label: "POS.OUT.L", name: "Position feed LEFT (front+rear+plate)", circuit: "c-position", from: { component: "sw-headlight", terminal: "58" }, to: { component: "park-fl", terminal: "58" }, gaugeClass: "medium", route: ["dash", "engine-front"], via: ["bh2", "bh4"] },
  { id: "w-pos-fr", label: "POS.OUT.R", name: "Position feed RIGHT (front+rear)", circuit: "c-position", from: { component: "sw-headlight", terminal: "58" }, to: { component: "park-fr", terminal: "58" }, gaugeClass: "medium", route: ["dash", "engine-front"], via: ["bh2", "bh4"] },
  ...
  { id: "w-side-L", label: "SIDE.L", name: "Turn-L output → side marker/repeater LEFT", circuit: "c-turn", from: { component: "rly-turnL", terminal: "87" }, to: { component: "side-l", terminal: "in" }, gaugeClass: "low", route: ["engine-front"], via: ["bh4"] },
  { id: "w-side-R", label: "SIDE.R", name: "Turn-R output → side marker/repeater RIGHT", circuit: "c-turn", from: { component: "rly-turnR", terminal: "87" }, to: { component: "side-r", terminal: "in" }, gaugeClass: "low", route: ["engine-front"], via: ["bh4"] },
